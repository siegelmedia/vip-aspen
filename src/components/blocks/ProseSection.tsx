  ...
  return (
    <div className={`max-w-4xl mx-auto ${className}`}>
      <motion.div {...fadeInUp}>
        {content.heading && (
          <>
            <p className="eyebrow text-center mb-4">In Depth</p>
            <h2 className="font-display text-3xl md:text-4xl font-semibold text-foreground mb-8 text-center text-balance">
