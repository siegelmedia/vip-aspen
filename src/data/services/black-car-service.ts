...
const data: ServicePageData = {
  ...
  features: [
    ...
    },
    {
      ...
      description:
        "Dedicated car service for Aspen's luxury hotels including Hotel Jerome, The St. Regis, and The Little Nell. We coordinate with concierge teams for seamless service.",
    },
    {
      icon: Users,
      title: "Group Transportation",
      description:
        "Our Executive Sprinter seats up to 13 passengers — ideal for family reunions, corporate groups, wedding parties, and multi-family ski trips.",
    },
    {
      icon: Snowflake,
      title: "Winter & Mountain Roads",
      description:
        "All vehicles are 4WD-equipped with winter tires and driven by experienced mountain road professionals. We handle Independence Pass, McClure Pass, and every canyon road in between.",
    },
    {
      icon: Calendar,
      title: "Multi-Day & Weekly",
      description:
        "Book a dedicated vehicle for your entire Aspen stay. Daily chauffeur service with the same driver, same vehicle, and priority scheduling.",
    },
  ],
  howItWorks: [
...
<p>We provide dedicated transportation for guests of Aspen's finest hotels, including <a href="/hotel-jerome-transportation">Hotel Jerome</a>, <a href="/st-regis-aspen-transportation">The St. Regis Aspen Resort</a>, and <a href="/little-nell-transportation">The Little Nell</a>. Our drivers know every property's entrance, loading zone, and concierge team. Whether you need an airport transfer on arrival or a dedicated driver for your entire stay, we coordinate directly with your hotel to ensure seamless service.</p>
<p>Our airport transfer service covers every airport serving the Aspen area: <a href="/aspen-airport-transfer">Aspen-Pitkin County (ASE)</a> just 5 minutes from town, <a href="/eagle-airport-transfer">Eagle County Regional (EGE)</a> a 90-minute scenic drive, <a href="/rifle-airport-transfer">Rifle Garfield County (RIL)</a> popular with private jet arrivals, and <a href="/denver-to-aspen-car-service">Denver International (DEN)</a> for the ultimate 3.5-hour luxury mountain transfer. Every transfer includes flight tracking, meet-and-greet, and complimentary wait time.</p>`,
  },
  relatedServices: [
